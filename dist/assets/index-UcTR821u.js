var R=Object.defineProperty;var k=(m,e,t)=>e in m?R(m,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[e]=t;var d=(m,e,t)=>k(m,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const x={ENGINES:"apex_engines_data_v1",THEME:"apex_theme_mode_v1",COMPARE:"apex_compare_ids_v1"};class E{static saveEngines(e){try{localStorage.setItem(x.ENGINES,JSON.stringify(e))}catch(t){console.error("Erreur lors de la sauvegarde dans LocalStorage:",t)}}static getEngines(){try{const e=localStorage.getItem(x.ENGINES);if(!e)return null;const t=JSON.parse(e);return Array.isArray(t)?t:null}catch(e){return console.error("Erreur lors de la lecture du LocalStorage:",e),null}}static saveTheme(e){try{localStorage.setItem(x.THEME,e)}catch(t){console.error("Erreur lors de la sauvegarde du thème:",t)}}static getTheme(){try{const e=localStorage.getItem(x.THEME);if(e==="dark"||e==="light"||e==="auto")return e}catch(e){console.error("Erreur lors de la lecture du thème:",e)}return"auto"}static saveCompareIds(e){try{localStorage.setItem(x.COMPARE,JSON.stringify(e))}catch(t){console.error("Erreur lors de la sauvegarde des comparaisons:",t)}}static getCompareIds(){try{const e=localStorage.getItem(x.COMPARE);return e?JSON.parse(e):[]}catch{return[]}}static exportToJsonFile(e){const t="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),s=document.createElement("a");s.setAttribute("href",t),s.setAttribute("download",`apex_engines_backup_${new Date().toISOString().slice(0,10)}.json`),document.body.appendChild(s),s.click(),s.remove()}static clearStorage(){try{localStorage.removeItem(x.ENGINES),localStorage.removeItem(x.COMPARE)}catch(e){console.error("Erreur lors du nettoyage du LocalStorage:",e)}}}function F(m,e){return new Proxy(m,{set(t,s,i,r){const a=String(s),n=t[s],l=typeof i=="object"&&i!==null&&!i._isProxy?F(i,e):i,p=Reflect.set(t,s,l,r);return n!==i&&e(a,i),p},deleteProperty(t,s){const i=String(s),r=s in t,a=Reflect.deleteProperty(t,s);return r&&e(i,void 0),a},get(t,s,i){return s==="_isProxy"?!0:Reflect.get(t,s,i)}})}class N{constructor(){d(this,"rawState");d(this,"state");d(this,"listeners",new Set);const e=E.getTheme(),t=E.getCompareIds();this.rawState={engines:[],filters:{searchQuery:"",configuration:"ALL",fuel:"ALL",aspiration:"ALL",onlyFavorites:!1,minPower:0,maxPower:2e3,sortBy:"power",sortOrder:"desc"},theme:e,selectedEngineId:null,compareEngineIds:t,isLoading:!0,errorMessage:null,activeView:"grid"},this.state=F(this.rawState,(s,i)=>{this.handleStateChange(s,i)})}handleStateChange(e,t){(e==="engines"||!isNaN(Number(e)))&&E.saveEngines(this.state.engines),e==="theme"&&E.saveTheme(this.state.theme),e==="compareEngineIds"&&E.saveCompareIds(this.state.compareEngineIds),this.notify(e)}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}notify(e){this.listeners.forEach(t=>{try{t(this.state,e)}catch(s){console.error("Erreur dans un listener de store:",s)}})}setEngines(e){this.state.engines=e,this.state.isLoading=!1,this.state.errorMessage=null}addEngine(e){const t={...e,id:"eng-"+Date.now().toString(36)+Math.random().toString(36).substring(2,6),isFavorite:!1,likes:0,createdAt:new Date().toISOString()};return this.state.engines=[t,...this.state.engines],t}updateEngine(e,t){const s=this.state.engines.findIndex(n=>n.id===e);if(s===-1)return!1;const r={...this.state.engines[s],...t,updatedAt:new Date().toISOString()},a=[...this.state.engines];return a[s]=r,this.state.engines=a,!0}deleteEngine(e){const t=this.state.engines.length;return this.state.engines=this.state.engines.filter(s=>s.id!==e),this.state.compareEngineIds.includes(e)&&(this.state.compareEngineIds=this.state.compareEngineIds.filter(s=>s!==e)),this.state.engines.length<t}toggleFavorite(e){const t=this.state.engines.find(s=>s.id===e);t&&this.updateEngine(e,{isFavorite:!t.isFavorite})}incrementLikes(e){const t=this.state.engines.find(s=>s.id===e);t&&this.updateEngine(e,{likes:(t.likes||0)+1})}setFilters(e){this.state.filters={...this.state.filters,...e}}resetFilters(){this.state.filters={searchQuery:"",configuration:"ALL",fuel:"ALL",aspiration:"ALL",onlyFavorites:!1,minPower:0,maxPower:2e3,sortBy:"power",sortOrder:"desc"}}setTheme(e){this.state.theme=e}setSelectedEngine(e){this.state.selectedEngineId=e}toggleCompare(e){const t=[...this.state.compareEngineIds],s=t.indexOf(e);return s>=0?(t.splice(s,1),this.state.compareEngineIds=t,!0):t.length>=3?!1:(t.push(e),this.state.compareEngineIds=t,!0)}clearCompare(){this.state.compareEngineIds=[]}setActiveView(e){this.state.activeView=e}getFilteredEngines(){const{searchQuery:e,configuration:t,fuel:s,aspiration:i,onlyFavorites:r,minPower:a,maxPower:n,sortBy:l,sortOrder:p}=this.state.filters,u=e.trim().toLowerCase();return this.state.engines.filter(o=>{if(u){const b=o.name.toLowerCase().includes(u),y=o.manufacturer.toLowerCase().includes(u),w=o.description.toLowerCase().includes(u),T=o.vehicles.some(q=>q.toLowerCase().includes(u));if(!b&&!y&&!w&&!T)return!1}return!(t!=="ALL"&&o.configuration!==t||s!=="ALL"&&o.fuel!==s||i!=="ALL"&&o.aspiration!==i||r&&!o.isFavorite||o.power<a||o.power>n)}).sort((o,b)=>{let y=0;return l==="power"?y=o.power-b.power:l==="torque"?y=o.torque-b.torque:l==="displacement"?y=o.displacement-b.displacement:l==="maxRpm"?y=o.maxRpm-b.maxRpm:l==="likes"?y=o.likes-b.likes:l==="name"?y=o.name.localeCompare(b.name):l==="manufacturer"&&(y=o.manufacturer.localeCompare(b.manufacturer)),p==="asc"?y:-y})}getStats(){const e=this.state.engines,t=e.length;if(t===0)return{total:0,avgPower:0,maxPowerEngine:null,highestRpmEngine:null,topLikedEngine:null,fuelBreakdown:{},configBreakdown:{}};const s=e.reduce((u,o)=>u+o.power,0),i=Math.round(s/t),r=[...e].sort((u,o)=>o.power-u.power)[0],a=[...e].sort((u,o)=>o.maxRpm-u.maxRpm)[0],n=[...e].sort((u,o)=>o.likes-u.likes)[0],l=e.reduce((u,o)=>(u[o.fuel]=(u[o.fuel]||0)+1,u),{}),p=e.reduce((u,o)=>(u[o.configuration]=(u[o.configuration]||0)+1,u),{});return{total:t,avgPower:i,maxPowerEngine:r,highestRpmEngine:a,topLikedEngine:n,fuelBreakdown:l,configBreakdown:p}}}const c=new N;class L{static async loadInitialEngines(){const e=E.getEngines();return e&&e.length>0?e:this.fetchFromApi()}static async fetchFromApi(){try{const e=await fetch(this.DATA_URL);if(!e.ok)throw new Error(`Erreur HTTP: ${e.status} ${e.statusText}`);const t=await e.json();return E.saveEngines(t),t}catch(e){throw console.error("Erreur lors du Fetch des données moteurs:",e),e}}static async resetToDefault(){return E.clearStorage(),this.fetchFromApi()}}d(L,"DATA_URL","/data/engines.json");function $(m,e={},t=[]){const s=document.createElement(m);for(const[i,r]of Object.entries(e))i==="className"||i==="class"?s.className=String(r):i.startsWith("data-")?s.setAttribute(i,String(r)):typeof r=="boolean"?r&&s.setAttribute(i,""):s.setAttribute(i,String(r));for(const i of t)typeof i=="string"?s.appendChild(document.createTextNode(i)):typeof i=="object"&&i!==null&&"nodeType"in i&&s.appendChild(i);return s}function M(m){for(;m.firstChild;)m.removeChild(m.firstChild)}function f(m){const e=document.createElement("div");return e.textContent=m,e.innerHTML}function v(m){return new Intl.NumberFormat("fr-FR").format(m)}class g{static getContainer(){return(!this.container||!document.body.contains(this.container))&&(this.container=$("div",{class:"toast-container","aria-live":"polite"}),document.body.appendChild(this.container)),this.container}static show(e,t="info",s=3500){const i=this.getContainer(),r={success:"✓",error:"✕",info:"ℹ"},a=$("div",{class:`toast toast-${t}`},[$("span",{style:"font-weight: 800; font-size: 1.1rem;"},[r[t]]),$("span",{style:"flex: 1;"},[e])]);i.appendChild(a),setTimeout(()=>{a.classList.add("removing"),setTimeout(()=>{a.remove()},250)},s)}}d(g,"container",null);class P{constructor(){d(this,"element");this.element=document.getElementById("app-navbar")||document.createElement("header"),this.render(),this.initThemeWatcher()}initThemeWatcher(){this.applyTheme(c.state.theme),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{c.state.theme==="auto"&&this.applyTheme("auto")})}applyTheme(e){const t=document.documentElement;if(e==="auto"){const s=window.matchMedia("(prefers-color-scheme: dark)").matches;t.setAttribute("data-theme",s?"dark":"light")}else t.setAttribute("data-theme",e)}render(){const e=c.state.theme,t={dark:"🌙",light:"☀️",auto:"💻"},s={dark:"light",light:"auto",auto:"dark"};this.element.className="app-header",this.element.innerHTML=`
    ...
    `,this.attachEvents(s[e])}attachEvents(e){const t=this.element.querySelector("#global-search-input");t&&t.addEventListener("input",l=>{const p=l.target.value;c.setFilters({searchQuery:p})});const s=this.element.querySelector("#btn-theme-toggle");s&&s.addEventListener("click",()=>{c.setTheme(e),this.applyTheme(e),this.render(),g.show(`Thème basculé sur : ${e}`,"info")});const i=this.element.querySelector("#btn-export-json");i&&i.addEventListener("click",()=>{E.exportToJsonFile(c.state.engines),g.show("Fichier JSON exporté avec succès !","success")});const r=this.element.querySelector("#btn-reset-data");r&&r.addEventListener("click",async()=>{if(confirm("Voulez-vous recharger la base de données de moteurs initiale ? Toutes vos modifications locales seront réinitialisées."))try{const l=await L.resetToDefault();c.setEngines(l),g.show("Base de données réinitialisée via Fetch API !","success")}catch{g.show("Erreur lors du rechargement des données.","error")}});const a=this.element.querySelector("#btn-add-engine");a&&a.addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("open-engine-form",{detail:{mode:"create"}}))});const n=this.element.querySelector("#brand-home-btn");n&&n.addEventListener("click",()=>{c.resetFilters(),t&&(t.value="")})}}class I{constructor(){d(this,"element");this.element=document.getElementById("stats-overview-container")||document.createElement("section"),c.subscribe(()=>this.render())}render(){const e=c.getStats();if(e.total===0){this.element.innerHTML="";return}this.element.className="stats-banner anim-fade-in",this.element.innerHTML=`
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-data">
            ...
            <div class="stat-value">${v(e.avgPower)} <span style="font-size: 0.9rem; font-weight: 500;">ch</span></div>
        ...
        <div class="stat-card">
          ...
          <div class="stat-data">
            ...
            <div class="stat-value">${e.maxPowerEngine?`${v(e.maxPowerEngine.power)} ch`:"-"}</div>
        ...
        <div class="stat-card">
          ...
          <div class="stat-data">
            ...
            <div class="stat-value">${e.highestRpmEngine?`${v(e.highestRpmEngine.maxRpm)} tr/min`:"-"}</div>
            <div class="stat-sub">${e.highestRpmEngine?e.highestRpmEngine.name:""}</div>
          </div>
        </div>
      </div>
    `}}class B{constructor(){d(this,"element");this.element=document.getElementById("filter-bar-container")||document.createElement("section"),c.subscribe((e,t)=>{(!t||t==="filters"||t==="engines")&&this.render()})}render(){const{configuration:e,fuel:t,aspiration:s,onlyFavorites:i,sortBy:r,sortOrder:a}=c.state.filters,n=[{id:"ALL",label:"Toutes les architectures"},{id:"V8",label:"V8"},{id:"V12",label:"V12"},{id:"V10",label:"V10"},{id:"Flat-6",label:"Flat-6 Boxer"},{id:"6 en ligne",label:"6 en ligne (L6)"},{id:"4 en ligne",label:"4 en ligne (L4)"},{id:"W16",label:"W16 Quad-Turbo"},{id:"Rotatif",label:"Wankel Rotatif"},{id:"Électrique",label:"Électrique"}];this.element.className="filter-section anim-fade-in",this.element.innerHTML=`
      <div class="filter-bar">
        ...
        <div class="filter-row">
          ...
          <div class="filter-selects">
            ...
            <button class="btn-icon" id="btn-toggle-sort-order" title="Inverser l'ordre (${a==="asc"?"Croissant":"Décroissant"})">
              <span>${a==="asc"?"↑":"↓"}</span>
            </button>
    ...
    `,this.attachEvents()}attachEvents(){this.element.querySelectorAll(".pill-btn[data-config]").forEach(l=>{l.addEventListener("click",()=>{const p=l.getAttribute("data-config")||"ALL";c.setFilters({configuration:p})})});const t=this.element.querySelector("#filter-fuel");t&&t.addEventListener("change",()=>{c.setFilters({fuel:t.value})});const s=this.element.querySelector("#filter-aspiration");s&&s.addEventListener("change",()=>{c.setFilters({aspiration:s.value})});const i=this.element.querySelector("#btn-toggle-favs");i&&i.addEventListener("click",()=>{c.setFilters({onlyFavorites:!c.state.filters.onlyFavorites})});const r=this.element.querySelector("#sort-by-select");r&&r.addEventListener("change",()=>{c.setFilters({sortBy:r.value})});const a=this.element.querySelector("#btn-toggle-sort-order");a&&a.addEventListener("click",()=>{const l=c.state.filters.sortOrder==="asc"?"desc":"asc";c.setFilters({sortOrder:l})});const n=this.element.querySelector("#btn-reset-filters");n&&n.addEventListener("click",()=>{c.resetFilters();const l=document.getElementById("global-search-input");l&&(l.value="")})}}class h{static initContext(){if(!this.ctx){const e=window.AudioContext||window.webkitAudioContext;this.ctx=new e}this.ctx.state==="suspended"&&this.ctx.resume()}static makeDistortionCurve(e=20){const t=typeof e=="number"?e:20,s=44100,i=new Float32Array(s),r=Math.PI/180;for(let a=0;a<s;++a){const n=a*2/s-1;i[a]=(3+t)*n*20*r/(Math.PI+t*Math.abs(n))}return i}static createNoiseBuffer(){if(!this.ctx)return null;const e=this.ctx.sampleRate*2,t=this.ctx.createBuffer(1,e,this.ctx.sampleRate),s=t.getChannelData(0);for(let i=0;i<e;i++)s[i]=Math.random()*2-1;return t}static start(e=500,t=8500){if(this.initContext(),!this.ctx)return;this.isPlaying&&this.stop();let s;typeof e=="object"?s=e:s={soundPitch:e,maxRpm:t,configuration:"V8",aspiration:"Atmosphérique",fuel:"Essence",name:"Moteur Générique"},this.currentEngine=s,this.config=s.configuration||"V8",this.isElectric=s.configuration==="Électrique"||s.fuel==="Électrique",this.isTurbo=["Turbo","Bi-Turbo","Quad-Turbo"].includes(s.aspiration||""),this.maxRpm=s.maxRpm||8500,this.idleRpm=this.isElectric?0:Math.round(this.maxRpm*.11),this.currentRpm=this.idleRpm;const i=this.ctx.currentTime;this.masterGain=this.ctx.createGain(),this.masterGain.gain.setValueAtTime(.001,i),this.masterGain.gain.exponentialRampToValueAtTime(.3,i+.12),this.waveShaper=this.ctx.createWaveShaper();const r=this.isElectric?0:this.getDistortionAmount(this.config);this.waveShaper.curve=this.makeDistortionCurve(r),this.waveShaper.oversample="4x",this.exhaustFilter=this.ctx.createBiquadFilter(),this.exhaustFilter.type=this.isElectric?"lowpass":"peaking",this.exhaustFilter.gain.setValueAtTime(4,i),this.exhaustFilter.Q.setValueAtTime(this.isElectric?1:3.5,i),this.setupOscillators(),this.isTurbo&&!this.isElectric&&this.setupTurbo(),this.waveShaper.connect(this.exhaustFilter),this.exhaustFilter.connect(this.masterGain),this.masterGain.connect(this.ctx.destination),this.updateFrequency(),this.isPlaying=!0}static setupOscillators(){if(!this.ctx||!this.waveShaper)return;this.osc1=this.ctx.createOscillator(),this.osc2=this.ctx.createOscillator(),this.osc3=this.ctx.createOscillator(),this.osc4=this.ctx.createOscillator();const e=this.ctx.createGain(),t=this.ctx.createGain(),s=this.ctx.createGain(),i=this.ctx.createGain();this.isElectric?(this.osc1.type="sine",this.osc2.type="triangle",this.osc3.type="sine",this.osc4.type="sine",e.gain.value=.55,t.gain.value=.25,s.gain.value=.2,i.gain.value=.15):this.config==="Rotatif"?(this.osc1.type="sawtooth",this.osc2.type="sawtooth",this.osc3.type="triangle",this.osc4.type="sawtooth",e.gain.value=.45,t.gain.value=.35,s.gain.value=.25,i.gain.value=.2):this.config==="V12"?(this.osc1.type="sawtooth",this.osc2.type="sawtooth",this.osc3.type="triangle",this.osc4.type="sawtooth",e.gain.value=.45,t.gain.value=.35,s.gain.value=.3,i.gain.value=.25):this.config==="V10"?(this.osc1.type="sawtooth",this.osc2.type="sawtooth",this.osc3.type="sawtooth",this.osc4.type="triangle",e.gain.value=.5,t.gain.value=.35,s.gain.value=.25,i.gain.value=.2):this.config==="5 en ligne"?(this.osc1.type="sawtooth",this.osc2.type="triangle",this.osc3.type="sawtooth",this.osc4.type="sawtooth",e.gain.value=.45,t.gain.value=.35,s.gain.value=.3,i.gain.value=.2,this.lfo=this.ctx.createOscillator(),this.lfo.type="sine",this.lfoGain=this.ctx.createGain(),this.lfoGain.gain.value=4,this.lfo.connect(this.lfoGain),this.lfoGain.connect(this.osc1.frequency),this.lfo.start()):this.config==="Flat-6"?(this.osc1.type="sawtooth",this.osc2.type="triangle",this.osc3.type="sawtooth",this.osc4.type="sawtooth",e.gain.value=.5,t.gain.value=.35,s.gain.value=.3,i.gain.value=.25):this.config==="W16"?(this.osc1.type="sawtooth",this.osc2.type="sawtooth",this.osc3.type="sawtooth",this.osc4.type="triangle",e.gain.value=.4,t.gain.value=.3,s.gain.value=.5,i.gain.value=.2):(this.osc1.type="sawtooth",this.osc2.type="triangle",this.osc3.type="sawtooth",this.osc4.type="sawtooth",e.gain.value=.5,t.gain.value=.35,s.gain.value=.3,i.gain.value=.15),this.osc1.connect(e),this.osc2.connect(t),this.osc3.connect(s),this.osc4.connect(i),e.connect(this.waveShaper),t.connect(this.waveShaper),s.connect(this.waveShaper),i.connect(this.waveShaper),this.osc1.start(),this.osc2.start(),this.osc3.start(),this.osc4.start()}static setupTurbo(){if(!this.ctx||!this.waveShaper)return;const e=this.createNoiseBuffer();e&&(this.turboNoise=this.ctx.createBufferSource(),this.turboNoise.buffer=e,this.turboNoise.loop=!0,this.turboFilter=this.ctx.createBiquadFilter(),this.turboFilter.type="bandpass",this.turboFilter.frequency.setValueAtTime(2500,this.ctx.currentTime),this.turboFilter.Q.setValueAtTime(5,this.ctx.currentTime),this.turboGain=this.ctx.createGain(),this.turboGain.gain.setValueAtTime(.001,this.ctx.currentTime),this.turboNoise.connect(this.turboFilter),this.turboFilter.connect(this.turboGain),this.turboGain.connect(this.waveShaper),this.turboNoise.start())}static getDistortionAmount(e){switch(e){case"Flat-6":return 35;case"V10":return 30;case"V12":return 22;case"Rotatif":return 40;case"5 en ligne":return 28;case"W16":return 18;default:return 20}}static getPulsesPerRevolution(e){switch(e){case"4 en ligne":case"Flat-4":return 2;case"5 en ligne":return 2.5;case"6 en ligne":case"Flat-6":case"V6":return 3;case"V8":return 4;case"V10":return 5;case"V12":return 6;case"W16":return 8;case"Rotatif":return 3;default:return 3}}static setRpm(e){this.currentRpm=Math.max(0,Math.min(e,this.maxRpm)),this.isPlaying&&this.updateFrequency()}static updateFrequency(){if(!this.ctx||!this.osc1||!this.osc2||!this.osc3||!this.osc4||!this.exhaustFilter)return;const e=this.ctx.currentTime,t=this.currentRpm,s=Math.max(.01,t/this.maxRpm);if(this.isElectric){const n=220+t*.18;this.osc1.frequency.setTargetAtTime(n,e,.04),this.osc2.frequency.setTargetAtTime(n*2,e,.04),this.osc3.frequency.setTargetAtTime(n*.5,e,.04),this.osc4.frequency.setTargetAtTime(n*3,e,.04);const l=600+s*5e3;this.exhaustFilter.frequency.setTargetAtTime(l,e,.04);return}const i=this.getPulsesPerRevolution(this.config),r=Math.max(18,t/60*i);this.config==="V12"?(this.osc1.frequency.setTargetAtTime(r,e,.035),this.osc2.frequency.setTargetAtTime(r*2,e,.035),this.osc3.frequency.setTargetAtTime(r*.5,e,.035),this.osc4.frequency.setTargetAtTime(r*3,e,.035)):this.config==="V10"?(this.osc1.frequency.setTargetAtTime(r,e,.035),this.osc2.frequency.setTargetAtTime(r*2,e,.035),this.osc3.frequency.setTargetAtTime(r*.5,e,.035),this.osc4.frequency.setTargetAtTime(r*2.5,e,.035)):this.config==="5 en ligne"?(this.osc1.frequency.setTargetAtTime(r,e,.035),this.osc2.frequency.setTargetAtTime(r*1.5,e,.035),this.osc3.frequency.setTargetAtTime(r*.5,e,.035),this.osc4.frequency.setTargetAtTime(r*2.5,e,.035),this.lfo&&this.lfo.frequency.setTargetAtTime(t/120,e,.04)):this.config==="Rotatif"?(this.osc1.frequency.setTargetAtTime(r*1.5,e,.035),this.osc2.frequency.setTargetAtTime(r*3,e,.035),this.osc3.frequency.setTargetAtTime(r*.75,e,.035),this.osc4.frequency.setTargetAtTime(r*4.5,e,.035)):this.config==="Flat-6"?(this.osc1.frequency.setTargetAtTime(r,e,.035),this.osc2.frequency.setTargetAtTime(r*2,e,.035),this.osc3.frequency.setTargetAtTime(r*.5,e,.035),this.osc4.frequency.setTargetAtTime(r*4,e,.035)):(this.osc1.frequency.setTargetAtTime(r,e,.035),this.osc2.frequency.setTargetAtTime(r*2,e,.035),this.osc3.frequency.setTargetAtTime(r*.5,e,.035),this.osc4.frequency.setTargetAtTime(r*3,e,.035));const a=250+s*2400;if(this.exhaustFilter.frequency.setTargetAtTime(a,e,.04),this.isTurbo&&this.turboFilter&&this.turboGain){const n=1800+s*5500;this.turboFilter.frequency.setTargetAtTime(n,e,.05);const l=Math.pow(s,2.2)*.18;this.turboGain.gain.setTargetAtTime(l,e,.05)}}static triggerBlowOffValve(){if(!this.ctx||!this.isTurbo||this.isElectric)return;const e=this.ctx.currentTime,t=this.createNoiseBuffer();if(!t)return;const s=this.ctx.createBufferSource();s.buffer=t;const i=this.ctx.createBiquadFilter();i.type="bandpass",i.frequency.setValueAtTime(3500,e),i.Q.setValueAtTime(4,e);const r=this.ctx.createGain();r.gain.setValueAtTime(.2,e),r.gain.exponentialRampToValueAtTime(.001,e+.35),s.connect(i),i.connect(r),r.connect(this.ctx.destination),s.start(e),s.stop(e+.4)}static revUp(e){if(!this.isPlaying)return;const t=Math.round(this.maxRpm*.96),s=this.idleRpm;let i=0;const r=setInterval(()=>{if(i+=.05,i<=.45){const a=s+(t-s)*Math.sin(i/.45*(Math.PI/2));this.setRpm(a),e==null||e(a)}else if(i<=.55){const a=(Math.random()-.5)*(this.maxRpm*.04),n=t+a;this.setRpm(n),e==null||e(n)}else if(i<=1){i===.6&&this.isTurbo&&this.triggerBlowOffValve();const a=(i-.55)/.45,n=t-(t-s)*Math.pow(a,1.8);this.setRpm(n),e==null||e(n)}else clearInterval(r),this.setRpm(s),e==null||e(s)},25)}static stop(){if(!(!this.isPlaying||!this.ctx||!this.masterGain))try{const e=this.ctx.currentTime;this.masterGain.gain.setValueAtTime(this.masterGain.gain.value,e),this.masterGain.gain.exponentialRampToValueAtTime(1e-4,e+.15),setTimeout(()=>{var t,s,i,r,a,n,l,p,u,o,b,y,w,T,q,S,A,C;try{(t=this.osc1)==null||t.stop(),(s=this.osc2)==null||s.stop(),(i=this.osc3)==null||i.stop(),(r=this.osc4)==null||r.stop(),(a=this.lfo)==null||a.stop(),(n=this.turboNoise)==null||n.stop(),(l=this.osc1)==null||l.disconnect(),(p=this.osc2)==null||p.disconnect(),(u=this.osc3)==null||u.disconnect(),(o=this.osc4)==null||o.disconnect(),(b=this.lfo)==null||b.disconnect(),(y=this.lfoGain)==null||y.disconnect(),(w=this.turboNoise)==null||w.disconnect(),(T=this.turboFilter)==null||T.disconnect(),(q=this.turboGain)==null||q.disconnect(),(S=this.waveShaper)==null||S.disconnect(),(A=this.exhaustFilter)==null||A.disconnect(),(C=this.masterGain)==null||C.disconnect()}catch{}this.isPlaying=!1,this.currentEngine=null},160)}catch{this.isPlaying=!1,this.currentEngine=null}}static getActiveStatus(){return this.isPlaying}static getCurrentEngine(){return this.currentEngine}}d(h,"ctx",null),d(h,"masterGain",null),d(h,"osc1",null),d(h,"osc2",null),d(h,"osc3",null),d(h,"osc4",null),d(h,"lfo",null),d(h,"lfoGain",null),d(h,"turboNoise",null),d(h,"turboFilter",null),d(h,"turboGain",null),d(h,"exhaustFilter",null),d(h,"waveShaper",null),d(h,"isPlaying",!1),d(h,"currentEngine",null),d(h,"currentRpm",800),d(h,"idleRpm",800),d(h,"maxRpm",8500),d(h,"isElectric",!1),d(h,"isTurbo",!1),d(h,"config","V8");class V{static render(e){const t=document.createElement("article");t.className="engine-card anim-card-item",t.setAttribute("data-id",e.id);const s=c.state.compareEngineIds.includes(e.id);let i="badge-default";return e.configuration.includes("V8")?i="badge-v8":e.configuration.includes("V12")||e.configuration.includes("W16")?i="badge-v12":e.aspiration.includes("Turbo")?i="badge-turbo":e.configuration==="Électrique"?i="badge-electric":e.configuration==="Rotatif"&&(i="badge-rotary"),t.innerHTML=`
      ...
      <div class="card-body">
        ...
        <div class="card-metrics-grid">
          <div class="metric-item">
            ...
            <span class="metric-val" style="color: var(--accent-primary);">${v(e.power)} <small style="font-size:0.7rem;">ch</small></span>
          </div>
          <div class="metric-item">
            <span class="metric-label">Couple</span>
            <span class="metric-val">${v(e.torque)} <small style="font-size:0.7rem;">Nm</small></span>
          </div>
          <div class="metric-item">
            <span class="metric-label">${e.configuration==="Électrique"?"Régime max":"Cylindrée"}</span>
            <span class="metric-val">${e.configuration==="Électrique"?`${v(e.maxRpm)}`:`${v(e.displacement)} <small style="font-size:0.7rem;">cm³</small>`}</span>
          </div>
        </div>
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <select id="input-config" name="configuration" class="form-select">
                ${s.map(a=>`<option value="${a}" ${e.configuration===a?"selected":""}>${a}</option>`).join("")}
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select id="input-fuel" name="fuel" class="form-select">
                ${i.map(a=>`<option value="${a}" ${e.fuel===a?"selected":""}>${a}</option>`).join("")}
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select id="input-aspiration" name="aspiration" class="form-select">
                ${r.map(a=>`<option value="${a}" ${e.aspiration===a?"selected":""}>${a}</option>`).join("")}
              </select>
            </div>
    ...
    `,this.attachFormEvents()}attachFormEvents(){var t,s,i;(t=this.backdrop.querySelector("#btn-close-modal"))==null||t.addEventListener("click",()=>this.close()),(s=this.backdrop.querySelector("#btn-cancel-form"))==null||s.addEventListener("click",()=>this.close()),this.backdrop.addEventListener("click",r=>{r.target===this.backdrop&&this.close()}),(i=this.backdrop.querySelector("#btn-submit-form"))==null||i.addEventListener("click",()=>{this.handleSubmit()}),this.backdrop.querySelectorAll("input, select, textarea").forEach(r=>{r.addEventListener("input",()=>{const a=r.name,n=this.backdrop.querySelector(`#error-${a}`);n&&(n.textContent="",r.classList.remove("has-error"))})})}handleSubmit(){const e=this.backdrop.querySelector("#engine-form");if(!e)return;const t=new FormData(e),s=(t.get("vehicles")||"").trim(),i=s?s.split(",").map(n=>n.trim()).filter(Boolean):[],r={name:(t.get("name")||"").trim(),manufacturer:(t.get("manufacturer")||"").trim(),configuration:t.get("configuration"),displacement:Number(t.get("displacement")),power:Number(t.get("power")),torque:Number(t.get("torque")),maxRpm:Number(t.get("maxRpm")),aspiration:t.get("aspiration"),fuel:t.get("fuel"),yearStart:Number(t.get("yearStart")),yearEnd:t.get("yearEnd")?Number(t.get("yearEnd")):null,vehicles:i,description:(t.get("description")||"").trim(),imageUrl:(t.get("imageUrl")||"").trim()||"https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=800",soundPitch:500},a=D.validate(r);if(this.backdrop.querySelectorAll(".field-error").forEach(n=>n.textContent=""),this.backdrop.querySelectorAll(".has-error").forEach(n=>n.classList.remove("has-error")),Object.keys(a).length>0){for(const[n,l]of Object.entries(a)){const p=this.backdrop.querySelector(`#error-${n}`),u=this.backdrop.querySelector(`[name="${n}"]`);p&&(p.textContent=l),u&&u.classList.add("has-error")}g.show("Veuillez corriger les erreurs dans le formulaire.","error");return}this.currentMode==="edit"&&this.currentEngineId?(c.updateEngine(this.currentEngineId,r),g.show(`Moteur "${r.name}" mis à jour avec succès !`,"success")):(c.addEngine(r),g.show(`Moteur "${r.name}" ajouté au catalogue !`,"success")),this.close()}}class O{constructor(){d(this,"backdrop");d(this,"currentEngine",null);d(this,"isAudioRunning",!1);this.backdrop=document.getElementById("engine-detail-modal")||document.createElement("div"),this.initEventListeners()}initEventListeners(){document.addEventListener("open-engine-detail",e=>{var s;const t=(s=e.detail)==null?void 0:s.engineId;if(t){const i=c.state.engines.find(r=>r.id===t);i&&this.open(i)}})}open(e){this.currentEngine=e,this.render(),this.backdrop.classList.add("open"),document.body.style.overflow="hidden"}close(){this.isAudioRunning&&(h.stop(),this.isAudioRunning=!1),this.backdrop.classList.remove("open"),document.body.style.overflow=""}render(){if(!this.currentEngine)return;const e=this.currentEngine;this.backdrop.className="modal-backdrop";const t=e.displacement>0?(e.power/(e.displacement/1e3)).toFixed(1):"N/A",s=Math.round(e.maxRpm*.12);this.backdrop.innerHTML=`
      <div class="modal-content" style="max-width: 800px;" role="dialog" aria-modal="true">
        ...
        <div class="modal-body">
          ...
          <div class="tachometer-widget">
            ...
            <div class="tacho-dial">
              <div class="tacho-dial-inner">
                ...
                <div style="font-size: 0.72rem; color: var(--text-muted); margin-top: 4px;">RUPTEUR: ${v(e.maxRpm)}</div>
              </div>
            </div>
          ...
          <div class="card-metrics-grid" style="grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));">
            <div class="metric-item">
              <span class="metric-label">Puissance</span>
              <span class="metric-val" style="color: var(--accent-primary);">${v(e.power)} ch</span>
            </div>
            <div class="metric-item">
              <span class="metric-label">Couple</span>
              <span class="metric-val">${v(e.torque)} Nm</span>
            </div>
            <div class="metric-item">
              <span class="metric-label">Cylindrée</span>
              <span class="metric-val">${e.displacement>0?`${v(e.displacement)} cm³`:"N/A"}</span>
            </div>
            <div class="metric-item">
            ...
            <div class="metric-item">
              ...
              <span class="metric-val">${v(e.maxRpm)} tr/min</span>
            </div>
          </div>
    ...
    `,this.attachEvents()}attachEvents(){var l,p,u;if(!this.currentEngine)return;const e=this.currentEngine,t=Math.round(e.maxRpm*.12);(l=this.backdrop.querySelector("#btn-close-detail"))==null||l.addEventListener("click",()=>this.close()),(p=this.backdrop.querySelector("#btn-close-detail-footer"))==null||p.addEventListener("click",()=>this.close()),this.backdrop.addEventListener("click",o=>{o.target===this.backdrop&&this.close()}),(u=this.backdrop.querySelector("#btn-edit-from-detail"))==null||u.addEventListener("click",()=>{const o=e.id;this.close(),document.dispatchEvent(new CustomEvent("open-engine-form",{detail:{mode:"edit",engineId:o}}))});const s=this.backdrop.querySelector("#btn-audio-toggle"),i=this.backdrop.querySelector("#btn-audio-text"),r=this.backdrop.querySelector("#btn-audio-rev"),a=this.backdrop.querySelector("#rpm-range-slider"),n=this.backdrop.querySelector("#tacho-rpm-display");s&&a&&r&&n&&(s.addEventListener("click",()=>{if(this.isAudioRunning)h.stop(),this.isAudioRunning=!1,i&&(i.textContent="Démarrer le moteur"),a.disabled=!0,r.disabled=!0,n.textContent=`${t}`,a.value=`${t}`,g.show("Contact coupé.","info");else{h.start(e),this.isAudioRunning=!0,i&&(i.textContent="Couper le contact"),a.disabled=!1,r.disabled=!1,n.textContent=`${t}`;const b=e.configuration==="Électrique"||e.fuel==="Électrique"?`Système électrique ${e.name} sous tension ! ⚡🔊`:`Moteur ${e.name} (${e.configuration}) démarré au ralenti ! 🔊`;g.show(b,"success")}}),a.addEventListener("input",()=>{const o=Number(a.value);n.textContent=`${v(o)}`,h.setRpm(o)}),r.addEventListener("click",()=>{h.revUp(o=>{n.textContent=`${v(Math.round(o))}`,a.value=`${Math.round(o)}`})}))}}class j{constructor(){d(this,"drawerElement");d(this,"modalElement");this.drawerElement=document.getElementById("compare-drawer")||document.createElement("aside"),this.modalElement=document.getElementById("compare-modal")||document.createElement("div"),c.subscribe((e,t)=>{(!t||t==="compareEngineIds"||t==="engines")&&this.renderDrawer()})}renderDrawer(){const e=c.state.compareEngineIds,t=c.state.engines.filter(s=>e.includes(s.id));this.drawerElement.className=`compare-drawer ${t.length>0?"open":""}`,this.drawerElement.innerHTML=`
    ...
    `,this.attachDrawerEvents()}attachDrawerEvents(){var e,t;this.drawerElement.querySelectorAll("[data-remove]").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-remove");i&&c.toggleCompare(i)})}),(e=this.drawerElement.querySelector("#btn-clear-compare"))==null||e.addEventListener("click",()=>{c.clearCompare(),g.show("Comparateur réinitialisé","info")}),(t=this.drawerElement.querySelector("#btn-launch-compare"))==null||t.addEventListener("click",()=>{this.openCompareModal()})}openCompareModal(){var i,r;const e=c.state.compareEngineIds,t=c.state.engines.filter(a=>e.includes(a.id));if(t.length<2)return;this.modalElement.className="modal-backdrop open",this.modalElement.innerHTML=`
            ...
            ${t.map(a=>`
              <div style="background: var(--bg-surface-elevated); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 1.25rem; display: flex; flex-direction: column;">
                <div style="height: 140px; border-radius: var(--radius-sm); overflow: hidden; margin-bottom: 1rem; background: #000;">
                  <img src="${f(a.imageUrl)}" alt="${f(a.name)}" style="width: 100%; height: 100%; object-fit: cover;" />
                </div>
                <h3 style="margin: 0; font-size: 1.15rem; color: var(--text-primary);">${f(a.name)}</h3>
                <div style="font-size: 0.8rem; color: var(--accent-secondary); font-weight: 600; margin-bottom: 1rem;">${f(a.manufacturer)}</div>
    ...
    `;const s=()=>{this.modalElement.classList.remove("open")};(i=this.modalElement.querySelector("#btn-close-compare-modal"))==null||i.addEventListener("click",s),(r=this.modalElement.querySelector("#btn-close-compare-footer"))==null||r.addEventListener("click",s),this.modalElement.addEventListener("click",a=>{a.target===this.modalElement&&s()})}}class H{constructor(){d(this,"formModal");d(this,"detailModal")}async init(){console.log("🏎️ Initialisation de ApexEngine (Vanilla TS + Proxy Store)..."),new P,new I,new B,new z,this.formModal=new G,this.detailModal=new O,new j,this.initKeyboardShortcuts();try{const e=await L.loadInitialEngines();c.setEngines(e),g.show(`${e.length} moteurs chargés avec succès !`,"success")}catch(e){console.error("Erreur lors du démarrage :",e),c.state.isLoading=!1,c.state.errorMessage="Impossible de charger la base de données.",g.show("Erreur de chargement des données.","error")}}initKeyboardShortcuts(){window.addEventListener("keydown",e=>{const t=e.target;if(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT")){e.key==="Escape"&&t.blur();return}if(e.key==="/"){e.preventDefault();const s=document.getElementById("global-search-input");s==null||s.focus(),s==null||s.select()}(e.key==="n"||e.key==="N")&&(e.preventDefault(),this.formModal.open("create")),e.key==="Escape"&&(this.formModal.close(),this.detailModal.close())})}}document.addEventListener("DOMContentLoaded",()=>{new H().init()});
